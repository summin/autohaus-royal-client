...
const Customers = ({ ...props }) => {
    ...
    const onClick = (e) => {
        ...
        setTitle(e.target.value ==
            "recentCustomers" ? "Letzte 10 Registrierungen" : e.target.value ==
    ...
    return (
     <Container>
                <Row>
                    ...
                    <Button className="m-2" onClick={onClick} value="recentCustomers" size="sm" variant="dark">Neueste</Button>
